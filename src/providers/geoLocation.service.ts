...
export class GeoLocationService {
  ...
  public searchFuzzy(poiString: string): Observable<AtlasSearchResult> {
    const url =
      'https://atlas.microsoft.com/search/fuzzy/json?subscription-key=' + this.azureMapsKey + '&api-version=1.0' + '&query=' + poiString;
    return this.httpClient.get<AtlasSearchResult>(url);
  }
